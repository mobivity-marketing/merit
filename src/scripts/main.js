...
var W = window.innerWidth, H = window.innerHeight;
	...
	var particle_count = 75,
		particles = [],
		colors   = ["rgba(141,198,63,0.3)", "rgba(86,158,164,0.3)", "rgba(168,123,181,0.3)","rgba(242,102,94,0.3)"];
    function Particle()
    {
        ...
        this.move = function()
        {
            ...
            {
                var particleActual = particles[j],
                    yd = particleActual.y - this.y,
                    xd = particleActual.x - this.x,
                ...
                if ( d < 200 )
                {
                    ...
                    context.lineTo(particleActual.x, particleActual.y);
